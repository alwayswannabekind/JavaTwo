...
public class AuthController {
    ...
    public void executeAuth() {
        ...
        if (login == null || password == null || login.isBlank() || password.isBlank()) {
            clientChat.showErrorDialog("Login and Password should be filled");
            return;
        }
        ...
        try {
            ...
            clientChat.showErrorDialog("Network transmission error!");
            e.printStackTrace();
        }
    }
            ...
            public void accept(String message) {
                if (message.startsWith(AUTH_OK_COMMAND)){
                    ...
                    Platform.runLater(new Runnable() {
                        @Override
                        public void run() {
                            clientChat.showErrorDialog("No user exists with such a login and password");
                        }
                    });
                }
            }
